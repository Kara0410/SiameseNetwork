...
for margin, activation_func in possible_combos:
    train_loss, valid_loss, train_acc, valid_acc, model_name = train_Triplet(margin=margin, activation_func=activation_func)
